...
inline fun <T : Table, T2 : Table> JoinOn2Clause<T, T2>.groupBy(group: (T, T2) -> Sequence<Projection>): Group2Clause<T, T2> {
...
inline fun <T : Table, T2 : Table, T3 : Table> JoinOn3Clause<T, T2, T3>.groupBy(group: (T, T2, T3) -> Sequence<Projection>): Group3Clause<T, T2, T3> {
    return Group3Clause(
...
inline fun <T : Table, T2 : Table, T3 : Table, T4 : Table> JoinOn4Clause<T, T2, T3, T4>.groupBy(
    group: (T, T2, T3, T4) -> Sequence<Projection>
