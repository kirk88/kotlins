...
import com.nice.common.widget.StatefulView.Companion.TYPE_CONTENT_VIEW
import com.nice.common.widget.StatefulView.Companion.TYPE_EMPTY_VIEW
import com.nice.common.widget.StatefulView.Companion.TYPE_ERROR_VIEW
import com.nice.common.widget.StatefulView.Companion.TYPE_LOADING_VIEW

class StatefulFrameLayout @JvmOverloads constructor(
    context: Context,
    attrs: AttributeSet? = null,
    defStyleAttr: Int = R.attr.statefulFrameLayoutStyle
    ...
    init {
        val a = context.obtainStyledAttributes(
            attrs,
            R.styleable.StatefulFrameLayout,
            defStyleAttr,
            R.style.Widget_AppCompat_StatefulFrameLayout
        )
        emptyLayoutId = a.getResourceId(R.styleable.StatefulFrameLayout_emptyLayout, NO_VALUE)
        loadingLayoutId = a.getResourceId(R.styleable.StatefulFrameLayout_loadingLayout, NO_VALUE)
        errorLayoutId = a.getResourceId(R.styleable.StatefulFrameLayout_errorLayout, NO_VALUE)
        ...
        defaultViewType = a.getInt(R.styleable.StatefulFrameLayout_defaultShow, TYPE_CONTENT_VIEW)
        a.recycle()
    }
    ...
    override fun attachTo(adapter: RecyclerView.Adapter<*>): StatefulView {
        ...
        dataObservers!!.getOrPut(adapter) { AdapterDataObserver(adapter) { this } }.register()
        return this
    }
        ...
        when (viewType) {
            TYPE_LOADING_VIEW -> {
                view.findViewById<ProgressBar>(R.id.loading_progress)?.apply {
                    ...
                    } else if (loadingProgressColor != NO_VALUE) {
